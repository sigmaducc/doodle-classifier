...
function preload() {
    ...
    bowtieData = loadBytes("data/bowtie1000.bin");
}
...
function setup() {
    ...
    prepareData(bowties, bowtieData, BOWTIE);
    ...
    training = training.concat(bowties.training);

    let testing = [];
    testing = testing.concat(cats.testing);
    testing = testing.concat(rainbows.testing);
    testing = testing.concat(bowties.testing);
